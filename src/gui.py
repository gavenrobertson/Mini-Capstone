...
def student_window():
    layout = [
        [sg.Text('Welcome, please enter the below information!')],
        [sg.Text('Last Name, First Name: '), sg.Input(key='-LASTFIRST-'), sg.Text('Phone #: '), sg.Input(key='-PHONE-'), sg.Text('Room #: '), sg.Input(key='-ROOM-')],
        ...
        [sg.Text('Name: '), sg.Input(key='-VISIT_NAME_ONE-'), sg.Text('Number: '), sg.Input(key='-VISIT_NUMBER_ONE-'), sg.Text('Relationship: '), sg.Input(key='-VISIT_RELATIONSHIP_ONE-')],
        [sg.Text('Name: '), sg.Input(key='-VISIT_NAME_TWO-'), sg.Text('Number: '), sg.Input(key='-VISIT_NUMBER_TWO-'), sg.Text('Relationship: '), sg.Input(key='-VISIT_RELATIONSHIP_TWO-')],
        [sg.Text('Instructor Recommendation:')],
        [sg.Radio('Yes', 'INSTRUCTOR', key='-INSTRUCTOR_YES-'), sg.Radio('No', 'INSTRUCTOR', key='-INSTRUCTOR_NO-'), sg.Radio('AFI', 'TYPINSTRUCTORE', key='-AFI-'), sg.Text('Date: '), sg.Input(key='-INSTRUCTOR_DATE-')],
        [sg.Text('MTL Recommendation:')],
        [sg.Radio('Yes', 'MTL', key='-MTL_YES-'), sg.Radio('No', 'MTL', key='-MTL_NO-'), sg.Text('Date: '), sg.Input(key='-MTL_DATE-')],
        ...
        [sg.Radio('Approved', 'COMMANDER', key='-COMMANDER_APPROVED-'), sg.Radio('Disapproved', 'COMMANDER', key='-COMMANDER_DISAPPROVED-'), sg.Text('Date: '), sg.Input(key='-COMMANDER_DATE-')],
